                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="/authentification-admin" class="user" action="" method="post" >
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                placeholder="Utilisateur" name="nom">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Valider">
                                    </form>
                                    <hr>
                                    <div class="text-center">
